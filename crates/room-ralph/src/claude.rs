...
mod tests {
    ...
    #[test]
    fn build_command_passes_room_token_env() {
        ...
        assert!(
            ...
            "ROOM_TOKEN should be set in child env"
        );
    }

    #[test]
    fn build_command_omits_room_token_when_none() {
        let cmd = build_claude_command("opus", &[], &[], &[], None);
        ...
        assert!(
            !has_room_token,
            "ROOM_TOKEN should not be set when token is None"
        );
    }
